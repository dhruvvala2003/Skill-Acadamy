  ...
  const handleSearch = (e) => {
    ...
    if (query.trim() === "") {
      ...
      const filtered = courses.filter((course) =>
        course.cousename.toLowerCase().includes(query)
      );
